-- sph_tb.vhd — testbench for sph_test.S
--
...
begin
    ...
    begin
        ...
        assert gpio_ddr = to_unsigned(255, 8)
            report "FAIL sph_tb: gpio_ddr = " & integer'image(to_integer(gpio_ddr))
                   & ", expected 255"
            severity error;
        assert gpio_port = to_unsigned(18, 8)
            report "FAIL sph_tb: gpio_port = " & integer'image(to_integer(gpio_port))
                   & ", expected 18 (0x12)"
            severity error;
